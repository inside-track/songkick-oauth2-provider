...
describe Songkick::OAuth2::Provider::Exchange do
  before do
    ...
    allow(Songkick::OAuth2).to receive(:random_string).and_return('random_string')
  end
  ...
  shared_examples_for "validates required parameters" do
    describe "missing grant_type" do
      ...
      it "is invalid" do
        expect(exchange.error).to eql("invalid_request")
        expect(exchange.error_description).to eql("Missing required parameter client_id")
      end
    end
    ...
    describe "with an unknown grant type" do
      ...
      it "is invalid" do
        expect(exchange.error).to eql("unsupported_grant_type")
        expect(exchange.error_description).to eql("The grant type unknown is not recognized")
      end
    end
    ...
    describe "with an unknown client_id" do
      ...
      it "is invalid" do
        expect(exchange.error).to eql("invalid_client")
        expect(exchange.error_description).to eql("Unknown client ID unknown")
      end
    end
    ...
    describe "missing client_secret" do
      ...
      it "is invalid" do
        expect(exchange.error).to eql("invalid_request")
        expect(exchange.error_description).to eql("Missing required parameter client_secret")
      end
    end
    ...
    describe "with a mismatched client_secret" do
      ...
      it "is invalid" do
        expect(exchange.error).to eql("invalid_client")
        expect(exchange.error_description).to eql("Parameter client_secret does not match")
      end
    end
    ...
    describe "with scopes not covered by the authorization code" do
      ...
      it "is invalid" do
        expect(exchange.error).to eql('invalid_scope')
        expect(exchange.error_description).to eql('The request scope was never granted by the user')
      end
    end
  end
  ...
  describe "using authorization_code grant type" do
    ...
    describe "missing redirect_uri" do
      ...
      it "is invalid" do
        expect(exchange.error).to eql("invalid_request")
        expect(exchange.error_description).to eql("Missing required parameter redirect_uri")
      end
    end
    ...
    describe "with a mismatched redirect_uri" do
      ...
      it "is invalid" do
        expect(exchange.error).to eql("redirect_uri_mismatch")
        expect(exchange.error_description).to eql("Parameter redirect_uri does not match registered URI")
      end
    ...
    describe "missing code" do
      ...
      it "is invalid" do
        expect(exchange.error).to eql("invalid_request")
        expect(exchange.error_description).to eql("Missing required parameter code")
      end
    end
    ...
    describe "with an unknown code" do
      ...
      it "is invalid" do
        expect(exchange.error).to eql("invalid_grant")
        expect(exchange.error_description).to eql("The access grant you supplied is invalid")
      end
    end
  ...
  describe "using password grant type" do
    ...
    describe "for a user with existing authorization" do
      ...
      describe "missing username" do
        ...
        it "is invalid" do
          expect(exchange.error).to eql('invalid_request')
          expect(exchange.error_description).to eql('Missing required parameter username')
        end
      end
      ...
      describe "missing password" do
        ...
        it "is invalid" do
          expect(exchange.error).to eql('invalid_request')
          expect(exchange.error_description).to eql('Missing required parameter password')
        end
      end
    ...
    describe "for a user with no existing authorization" do
      ...
      describe "with ungranted but permissible scopes" do
        ...
        it "sets the scope from the request" do
          exchange.update_authorization
          authorization.reload
          expect(authorization.scopes).to eql(Set.new(['lol']))
        end
      end
    end
  end
  ...
  describe "using assertion grant type" do
    ...
    describe "missing assertion_type" do
      ...
      it "is invalid" do
        expect(exchange.error).to eql('invalid_request')
        expect(exchange.error_description).to eql('Missing required parameter assertion_type')
      end
    end
    ...
    describe "with a non-URI assertion_type" do
      ...
      it "is invalid" do
        expect(exchange.error).to eql('invalid_request')
        expect(exchange.error_description).to eql('Parameter assertion_type must be an absolute URI')
      end
    end
    ...
    describe "missing assertion" do
      ...
      it "is invalid" do
        expect(exchange.error).to eql('invalid_request')
        expect(exchange.error_description).to eql('Missing required parameter assertion')
      end
    end
    ...
    describe "with an unrecognized assertion_type" do
      ...
      it "is invalid" do
        expect(exchange.error).to eql('unauthorized_client')
        expect(exchange.error_description).to eql('Client cannot use the given assertion type')
      end
    end
